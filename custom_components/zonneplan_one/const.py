    ...
    P1_INSTALL: {
        "totals": {
            ...
            "electricity_delivery_costs_this_month": ZonneplanSensorEntityDescription(
                key="electricity_data.measurement_groups.1.meta.delivery_costs_incl_tax",
                ...
                entity_registry_enabled_default=False,
                state_class=SensorStateClass.TOTAL,
                last_reset_key="electricity_data.measurement_groups.1.date",
                none_value_behaviour=NONE_IS_ZERO,
            ),
            ...
            "electricity_production_costs_this_month": ZonneplanSensorEntityDescription(
                key="electricity_data.measurement_groups.1.meta.production_costs_incl_tax",
