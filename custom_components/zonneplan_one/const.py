...
SENSOR_TYPES: dict[str, dict[str, ZonneplanSensorEntityDescription] | dict[str, dict[str, ZonneplanSensorEntityDescription]]] = {
    ...
    BATTERY: {
        ...
        "electricity_home_consumption_delivery_costs_this_month": ZonneplanSensorEntityDescription(
            key="electricity_home_consumption.measurement_groups.2.meta.delivery_costs_incl_tax",
            name="Delivery costs this month",
            translation_key="electricity_home_consumption_delivery_costs_this_month",
            native_unit_of_measurement=CURRENCY_EURO,
            device_class=SensorDeviceClass.MONETARY,
            state_class=SensorStateClass.TOTAL,
            value_factor=0.0000001,
            none_value_behaviour=NONE_IS_ZERO,
            last_reset_key="electricity_home_consumption.measurement_groups.2.date",
        ),
        "electricity_home_consumption_delivery_costs_this_year": ZonneplanSensorEntityDescription(
            key="electricity_home_consumption.measurement_groups.3.meta.delivery_costs_incl_tax",
            name="Delivery costs this year",
            translation_key="electricity_home_consumption_delivery_costs_this_year",
            native_unit_of_measurement=CURRENCY_EURO,
            device_class=SensorDeviceClass.MONETARY,
            state_class=SensorStateClass.TOTAL,
            value_factor=0.0000001,
            none_value_behaviour=NONE_IS_ZERO,
            last_reset_key="electricity_home_consumption.measurement_groups.3.date",
        ),
        "electricity_home_consumption_production_costs_this_month": ZonneplanSensorEntityDescription(
            key="electricity_home_consumption.measurement_groups.2.meta.production_costs_incl_tax",
            name="Production costs this month",
            translation_key="electricity_home_consumption_production_costs_this_month",
            native_unit_of_measurement=CURRENCY_EURO,
            device_class=SensorDeviceClass.MONETARY,
            state_class=SensorStateClass.TOTAL,
            value_factor=0.0000001,
        ...
        "electricity_home_consumption_production_costs_this_year": ZonneplanSensorEntityDescription(
            key="electricity_home_consumption.measurement_groups.3.meta.production_costs_incl_tax",
            name="Production costs this year",
            translation_key="electricity_home_consumption_production_costs_this_year",
            native_unit_of_measurement=CURRENCY_EURO,
            device_class=SensorDeviceClass.MONETARY,
            state_class=SensorStateClass.TOTAL,
            value_factor=0.0000001,
        ...
        "electricity_home_consumption_energy_delivered_sum_today": ZonneplanSensorEntityDescription(
            key="electricity_home_consumption.measurement_groups.2.measurements.-1.values.d",
            name="Delivery today",
            translation_key="electricity_home_consumption_energy_delivered_sum_today",
            native_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR,
            value_factor=0.001,
            device_class=SensorDeviceClass.ENERGY,
            state_class=SensorStateClass.TOTAL_INCREASING,
        ...
        "electricity_home_consumption_energy_delivered_sum_this_month": ZonneplanSensorEntityDescription(
            key="electricity_home_consumption.measurement_groups.2.meta.energy_delivered_sum",
            name="Delivery this month",
            translation_key="electricity_home_consumption_energy_delivered_sum_this_month",
            native_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR,
            value_factor=0.001,
            device_class=SensorDeviceClass.ENERGY,
            state_class=SensorStateClass.TOTAL_INCREASING,
        ...
        "electricity_home_consumption_energy_delivered_sum_this_year": ZonneplanSensorEntityDescription(
            key="electricity_home_consumption.measurement_groups.3.meta.energy_delivered_sum",
            name="Delivery this year",
            translation_key="electricity_home_consumption_energy_delivered_sum_this_year",
            native_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR,
            value_factor=0.001,
            device_class=SensorDeviceClass.ENERGY,
            state_class=SensorStateClass.TOTAL_INCREASING,
        ...
        "electricity_home_consumption_energy_produced_sum_today": ZonneplanSensorEntityDescription(
            key="electricity_home_consumption.measurement_groups.2.measurements.-1.values.p",
            name="Production today",
            translation_key="electricity_home_consumption_energy_produced_sum_today",
            native_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR,
            value_factor=0.001,
            device_class=SensorDeviceClass.ENERGY,
            state_class=SensorStateClass.TOTAL_INCREASING,
        ...
        "electricity_home_consumption_energy_produced_sum_this_month": ZonneplanSensorEntityDescription(
            key="electricity_home_consumption.measurement_groups.2.meta.energy_produced_sum",
            name="Production this month",
            translation_key="electricity_home_consumption_energy_produced_sum_this_month",
            native_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR,
            value_factor=0.001,
            device_class=SensorDeviceClass.ENERGY,
            state_class=SensorStateClass.TOTAL_INCREASING,
        ...
        "electricity_home_consumption_energy_produced_sum_this_year": ZonneplanSensorEntityDescription(
            key="electricity_home_consumption.measurement_groups.3.meta.energy_produced_sum",
            name="Production this year",
            translation_key="electricity_home_consumption_energy_produced_sum_this_year",
            native_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR,
            value_factor=0.001,
            device_class=SensorDeviceClass.ENERGY,
            state_class=SensorStateClass.TOTAL_INCREASING,
